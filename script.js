...
submit.addEventListener('click', () => {
    ...
    console.log(`Remaining letters: ${uncommonLetters}`);

    let result = flamesResult(uncommonLetters);
    console.log("FLAMES Result:", result);

    displayResult.textContent = `The relationship between ${partner1.value} and ${partner2.value} is : ${result}`;
    partner1.value="";
    partner2.value="";
});
